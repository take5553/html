...
Driver Info (not using libv4l2):
        ...
        Card type     : HD Webcam eMeet C960
...
Crop Capability Video Capture:
        ...
        Pixel Aspect: 1/1
Selection: crop_default, Left 0, Top 0, Width 352, Height 288
Selection: crop_bounds, Left 0, Top 0, Width 352, Height 288
Streaming Parameters Video Capture:
        Capabilities     : timeperframe
        Frames per second: 30.000 (30/1)
        Read buffers     : 0
                     brightness 0x00980900 (int)    : min=60 max=225 step=1 default=138 value=138
                       contrast 0x00980901 (int)    : min=60 max=225 step=1 default=128 value=128
                     saturation 0x00980902 (int)    : min=1 max=255 step=1 default=118 value=118
~~~

## 変更可能オプションの表示

~~~shell
$ v4l2-ctl -d 0 --list-ctrls-menu
~~~
...
`--list-ctrls-menu`の代わりに`-L`でも可。

## 変更可能オプションの設定値読み取り、設定

読み取り

~~~shell
$ v4l2-ctl -d 0 -C brightness
~~~
